 ...
 *
 * The id is a ULID generated by the start action (it is used to compose the code_hmac).
 * The plaintext code is NEVER stored: only `code_hmac` (+ `code_salt`, `key_version`).
 *
 * @property string $id
